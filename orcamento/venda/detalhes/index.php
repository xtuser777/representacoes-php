...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Detalhes do Orçamento de Venda - Sistema de Controle de Representações</title>
    ...
    <body>
        ...
        <div style="display: none; min-width: 300px; width: 700px" id="fbFrmAddProduto">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <label for="text_qtde_prod">Quantidade desejada:</label>
        ...
        <script src="/representacoes/static/js/orcamento/venda/detalhes.js"></script>
        <script src="/representacoes/static/js/orcamento/venda/detalhes_add_item.js"></script>
