...
<div class="card-title">
    <div class="card-title-container" style="text-align: center;">
        <h4><b>SCR - Cadastrar Novo Motorista</b></h4>
    </div>
</div>
...
<div class="fieldset-card">
    <div class="fieldset-card-legend">Dados de contato do motorista</div>
    <div class="fieldset-card-container">
        <div class="row">
            <div class="col-sm-9">
...
<div class="row">
    <div class="col-sm-2">
        <a role="button" id="voltar" class="btn btn-default" style="width: 100%;" href="/representacoes/gerenciar/motorista">VOLTAR</a>
    </div>
