...
<div class="card-title">
    <div class="card-title-container" style="text-align: center;">
        <h4><b>SCR - Cadastrar Nova Representação</b></h4>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-2">
        <a role="button" id="voltar" class="btn btn-default" style="width: 100%;" href="/representacoes/gerenciar/representacao">VOLTAR</a>
    </div>

    <div class="col-sm-6"></div>

    <div class="col-sm-2">
        <button id="limpar" class="btn btn-primary" style="width: 100%;" onclick="limparCampos();">LIMPAR</button>
    </div>
