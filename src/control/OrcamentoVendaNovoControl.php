...
class OrcamentoVendaNovoControl
{
    ...
    public function gravar(int $cli, string $nc, string $dc, string $tc, string $cc, string $ec, string $desc, int $vdd, int $cid, float $peso, float $valor, string $venc, array $itens)
    {
