...
$(document).ready(function () {
    ...
    var response = get("/gerenciar/representacao/detalhes/obter.php");
...
function verificarCnpj(cnpj) {
    $.ajax({
        type: 'POST',
        url: '/gerenciar/representacao/detalhes/verificar-cnpj.php',
        data: { cnpj: cnpj },
        async: false,
...
function gravar() {
    ...
    if (erros === 0) {
        ...
        $.ajax({
            type: 'POST',
            url: '/gerenciar/representacao/detalhes/alterar.php',
            data: form,
            contentType: false,
            processData: false,
            success: function (response) {
