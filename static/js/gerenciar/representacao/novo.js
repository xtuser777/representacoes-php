...
function verificarCnpj(cnpj) {
    $.ajax({
        type: 'POST',
        url: '/gerenciar/representacao/novo/verificar-cnpj.php',
        data: { cnpj: cnpj },
        async: false,
...
function gravar() {
    ...
    if (erros === 0) {
        ...
        $.ajax({
            type: 'POST',
            url: '/gerenciar/representacao/novo/gravar.php',
            data: form,
            contentType: false,
            processData: false,
            success: function (response) {
                if (response.length > 0) {
                    ...
                    mostraDialogo(
                        "<strong>Representação cadastrada com sucesso!</strong>" +
                        "<br/>A nova representação foi salvo com sucesso no sistema...",
                        "success",
                        2000
                    );
                    limparCampos();
            ...
            error: function (http, status, thrown) {
                mostraDialogo(
                    "<strong>Ocorreu um problema ao se comunicar com o servidor...</strong>" +
                    "<br/>"+thrown,
                    "danger",
