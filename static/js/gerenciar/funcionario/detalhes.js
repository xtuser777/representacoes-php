...
$(document).ready(function () {
    ...
    var response = get("/gerenciar/funcionario/detalhes/obter-detalhes.php");
...
btvoltar.addEventListener("click", function (event) {
    limparCampos();
    window.location.href = "../../gerenciar/funcionario";
});
...
function verificarLogin(login) {
    $.ajax({
        type: 'POST',
        url: '/gerenciar/funcionario/detalhes/verificar-login.php',
        data: { login: login },
        async: false,
...
function verificarAdmin() {
    var data = get("/gerenciar/funcionario/detalhes/is-last-admin.php");
...
function verificarCpf(cpf) {
    $.ajax({
        type: 'POST',
        url: '/gerenciar/funcionario/detalhes/verificar-cpf.php',
        data: { cpf: cpf },
        async: false,
        success: function (response) {
...
btsalvar.addEventListener("click", function (event) {
    ...
    if (erros === 0) {
        ...
        $.ajax({
            type: 'POST',
            url: '/gerenciar/funcionario/detalhes/alterar.php',
            data: form,
            contentType: false,
            processData: false,
            success: function (response) {
