...
function verificarLogin(login) {
    $.ajax({
        type: 'POST',
        url: '/representacoes/gerenciar/funcionario/novo/verificar-login.php',
        data: { login: login },
        async: false,
...
function verificarCpf(cpf) {
    $.ajax({
        type: 'POST',
        url: '/representacoes/gerenciar/funcionario/novo/verificar-cpf.php',
        data: { cpf: cpf },
        async: false,
        success: function (response) {
            if (response === true) {
...
btsalvar.addEventListener("click", function (event) {
    ...
    if (erros === 0) {
        ...
        $.ajax({
            type: 'POST',
            url: '/representacoes/gerenciar/funcionario/novo/gravar.php',
            data: form,
            contentType: false,
            processData: false,
            success: function (response) {
