...
function verificarCpf(cpf) {
    $.ajax({
        type: 'POST',
        url: '/representacoes/gerenciar/cliente/novo/verificar-cpf.php',
        data: { cpf: cpf },
        async: false,
...
function verificarCnpj(cnpj) {
    $.ajax({
        type: 'POST',
        url: '/representacoes/gerenciar/cliente/novo/verificar-cnpj.php',
        data: { cnpj: cnpj },
        async: false,
        success: function (response) {
            if (response === true) {
...
function gravar() {
    ...
    if (erros === 0) {
        ...
        $.ajax({
            type: 'POST',
            url: '/representacoes/gerenciar/cliente/novo/gravar.php',
            data: form,
            contentType: false,
            processData: false,
            success: function (response) {
