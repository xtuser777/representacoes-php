...
function selectMotoristaChange() {
    ...
    if (motoId !== 0) {
        ...
        textNome.disabled = true;
        textRg.disabled = true;
        textCpf.disabled = true;
        dateNasc.disabled = true;
        textRua.disabled = true;
        textNumero.disabled = true;
        textBairro.disabled = true;
        textComplemento.disabled = true;
        selectEstado.disabled = true;
        selectCidade.disabled = true;
        textCep.disabled = true;
        textTelefone.disabled = true;
...
async function gravar() {
    ...
    if (await validar()) {
        ...
        await $.ajax({
            type: "POST",
            url: "/representacoes/gerenciar/proprietario/novo/gravar.php",
            data: frm,
            contentType: false,
            processData: false,
            success: function (response) {
