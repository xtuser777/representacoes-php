...
async function obter(ordem = '1') {
    let res = await postJSON(
        '/representacoes/relatorio/orcamento/venda/obter.php',
        { ordem: ordem }
    );
...
async function obterPorFiltroPeriodoCliente(filtro, inicio, fim, cliente, ordem) {
    ...
    if (dateInicio > dateFim) {
        ...
        let res = await postJSON(
            '/representacoes/relatorio/orcamento/venda/obter-por-filtro-periodo-cliente.php',
            {
                filtro: filtro,
                inicio: inicio,
                fim : fim,
...
async function obterPorFiltroPeriodo(filtro, inicio, fim, ordem) {
    ...
    if (dateInicio > dateFim) {
        ...
        let res = await postJSON(
            '/representacoes/relatorio/orcamento/venda/obter-por-filtro-periodo.php',
            {
                filtro: filtro,
                inicio: inicio,
                fim : fim,
...
async function obterPorFiltroCliente(filtro, cliente, ordem) {
    let res = await postJSON(
        '/representacoes/relatorio/orcamento/venda/obter-por-filtro-cliente.php',
        {
            filtro: filtro,
            cliente: cliente,
            ordem: ordem
...
async function obterPorFiltro(filtro, ordem) {
    let res = await postJSON(
        '/representacoes/relatorio/orcamento/venda/obter-por-filtro.php',
        {
            filtro: filtro,
            ordem: ordem
        }
...
async function obterPorPeriodoCliente(inicio, fim, cliente, ordem) {
    ...
    if (dateInicio > dateFim) {
        ...
        let res = await postJSON(
            '/representacoes/relatorio/orcamento/venda/obter-por-periodo-cliente.php',
            {
                inicio: inicio,
                fim : fim,
                cliente: cliente,
...
async function obterPorPeriodo(inicio, fim, ordem) {
    ...
    if (dateInicio > dateFim) {
        ...
        let res = await postJSON(
            '/representacoes/relatorio/orcamento/venda/obter-por-periodo.php',
            {
                inicio: inicio,
                fim : fim,
                ordem: ordem
...
async function obterPorCliente(cliente, ordem) {
    let res = await postJSON(
        '/representacoes/relatorio/orcamento/venda/obter-por-cliente.php',
        {
            cliente: cliente,
            ordem: ordem
        }
...
function emitir() {
    ...
    const guia = window.open(`/representacoes/relatorio/orcamento/venda/emitir.php?filtro=${filtro}&inicio=${inicio}&fim=${fim}&cliente=${cliente}&ordem=1`, '_blank');
    guia.focus();
}