...
<head>
    ...
    <title>Controlar Comissões - Sistema de Controle de Representações</title>
...
<div class="container">
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Filtragem de pedidos de venda</div>
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Pedidos filtrados</div>
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Comissões selecionadas</div>

        <div class="fieldset-card-container">

            <table id="tableComissoesVenda" class="table table-responsive" style="width: 100%;">
                <thead>
                <tr>
                    <th class="hidden">ID</th>
                    <th>CONTA</th>
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Recebimento das comissões de venda</div>

        <div class="fieldset-card-container">
            <div class="row">
                <div class="col-sm-2">
                    <label for="textValorComissaoVenda">Valor:</label>
                    <div class="input-group">
                        <div class="input-group-addon">R$</div>
                        <input type="text" id="textValorComissaoVenda" class="form-control input-sm" style="width: 100%;" readonly />
                    </div>
                </div>

                <div class="col-sm-2">
                    <label for="textValorRecebidoComissaoVenda">Valor Recebido <span style="color: red;">*</span>:</label>
                    <div class="input-group">
                        <div class="input-group-addon">R$</div>
                        <input type="text" id="textValorRecebidoComissaoVenda" class="form-control input-sm" style="width: 100%;" />
                    </div>
                    <div id="msvalorrecebido"></div>
                </div>

                <div class="col-sm-3">
                    <label for="selectFormaRecebimento">Forma Recebimento <span style="color: red;">*</span>:</label>
                    <select id="selectFormaRecebimento" class="form-control input-sm">
                        <option value="0">SELECIONAR</option>
                    </select>
                </div>

                <div class="col-sm-2">
                    <label for="dateRecebimento">Data Recebimento:</label>
                    <input type="date" id="dateRecebimento" class="form-control input-sm" style="width: 100%;" />
                </div>

                <div class="col-sm-3">
                    <label for="receber">&nbsp;</label>
                    <button id="receber" class="btn btn-success btn-sm" style="width: 100%;" onclick="receber();">RECEBER</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Comissões para vendedores externos</div>

        <div class="fieldset-card-container">

            <table id="tableComissoesVendedor" class="table table-responsive" style="width: 100%;">
                <thead>
                <tr>
                    <th class="hidden">ID</th>
                    <th>CONTA</th>
                ...
                <tbody id="tbodyComissoesVendedor">
                </tbody>
            </table>
        </div>
    </div>
    ...
    <div class="fieldset-card">
        <div class="fieldset-card-legend">Pagamento das comissões aos vendedores</div>

        <div class="fieldset-card-container">
            <div class="row">
                <div class="col-sm-2">
                    <label for="textValorComissaoVendedor">Valor:</label>
                    <div class="input-group">
                        <div class="input-group-addon">R$</div>
                        <input type="text" id="textValorComissaoVendedor" class="form-control input-sm" style="width: 100%;" readonly />
                    </div>
                </div>

                <div class="col-sm-2">
                    <label for="textValorPagoComissaoVendedor">Valor Pago <span style="color: red;">*</span>:</label>
                    <div class="input-group">
                        <div class="input-group-addon">R$</div>
                        <input type="text" id="textValorPagoComissaoVendedor" class="form-control input-sm" style="width: 100%;" />
                    </div>
                    <div id="msvalorpago"></div>
                </div>

                <div class="col-sm-3">
                    <label for="selectFormaPagamento">Forma Pagamento <span style="color: red;">*</span>:</label>
                    <select id="selectFormaPagamento" class="form-control input-sm">
                        <option value="0">SELECIONAR</option>
                    </select>
                </div>

                <div class="col-sm-2">
                    <label for="datePagamento">Data Pagamento:</label>
                    <input type="date" id="datePagamento" class="form-control input-sm" style="width: 100%;" />
                </div>

                <div class="col-sm-3">
                    <label for="pagar">&nbsp;</label>
                    <button id="pagar" class="btn btn-success btn-sm" style="width: 100%;" onclick="pagar();">PAGAR</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="/representacoes/static/js/controlar/comissao/index.js"></script>
